...
export default function Home() {
  ...
  const featuredClients = clients.filter((client) => featuredClientNames.includes(client.name));
  const remainingClients = clients.filter((client) => !featuredClientNames.includes(client.name));
