...
export default function Home() {
  ...
  return <main>
    ...
    <section className="credentials" aria-label="Trayectoria del equipo detrás de SYNC"><div className="trust-fixed"><p><span className="trust-mark trust-mark-years" aria-hidden="true">17</span><b>17 AÑOS</b><small>de experiencia en eventos</small></p><p><span className="trust-mark trust-mark-events" aria-hidden="true">●●●</span><b>+1.000 EVENTOS</b><small>corporativos y sociales</small></p><p><span className="trust-mark trust-mark-google" aria-hidden="true">G</span><b>+300 RESEÑAS</b><small><strong>★★★★★</strong> en Google</small></p></div></section>
