...
export default function Home() {
  ...
  return <main>
    ...
    <section className="credentials"><div><b>+5.000</b><span>eventos realizados por nuestro equipo</span></div><div><b>+300</b><span>reseñas 5 estrellas en Google</span></div><div><b>cientos</b><span>de empresas atendidas</span></div><div><b>17 años</b><span>de experiencia en eventos</span></div><p>Experiencia del equipo detrás de Karaoken Shows.</p></section>

    <section className="quick-trust"><div><p className="section-label">RESPALDO</p><h2>SYNC nace del equipo detrás de <em>Karaoken Shows.</em></h2></div><div><p>Más de 17 años produciendo entretenimiento para eventos, más de 5.000 eventos realizados y más de 300 reseñas 5 estrellas en Google.</p><a className="text-link" href="https://www.showdekaraoke.com/quienes-somos/" target="_blank" rel="noreferrer">Conocé nuestra trayectoria <Arrow /></a></div></section>
    ...
    <section className="proof section"><div><div className="section-label">05 — EMPRESAS</div><h2>Empresas que confiaron<br /><em>en nuestro equipo.</em></h2><p>Espacio preparado para integrar logos reales de las empresas con las que trabajó el equipo.</p></div><div className="company-marquees" aria-label="Espacio preparado para logos de empresas reales"><div className="company-track">{Array.from({ length: 25 }, (_, index) => <span key={`a-${index}`}>LOGO</span>)}{Array.from({ length: 25 }, (_, index) => <span key={`b-${index}`}>LOGO</span>)}</div><div className="company-track reverse">{Array.from({ length: 25 }, (_, index) => <span key={`c-${index}`}>LOGO</span>)}{Array.from({ length: 25 }, (_, index) => <span key={`d-${index}`}>LOGO</span>)}</div></div></section>
    <section className="reviews section" data-review-widget-slot="google-reviews"><div><div className="section-label">06 — RESEÑAS</div><h2>Más de 300 reseñas<br /><em>5 estrellas en Google.</em></h2><p>Opiniones reales de clientes del equipo detrás de SYNC.</p><a className="button review-cta" href="https://maps.app.goo.gl/djVvNZNHfwS8qsja9" target="_blank" rel="noreferrer">Ver todas las reseñas en Google <Arrow /></a></div><div className="review-slots">{Array.from({ length: 6 }, (_, slot) => <article key={slot}><span className="review-stars">★★★★★</span><p>Espacio preparado para incorporar una reseña real destacada.</p><footer><b>NOMBRE DEL CLIENTE</b><small>EMPRESA / TIPO DE EVENTO</small></footer></article>)}</div></section>

    <section id="nosotros" className="about section"><div className="section-label">07 — RESPALDO</div><div className="split"><h2>Una propuesta nueva.<br /><em>Un equipo con historia.</em></h2><div><p className="large-copy">SYNC nace del equipo de Karaoken Shows. Más de 17 años, más de 5.000 eventos y cientos de empresas nos dieron la experiencia para desarrollar una nueva propuesta enfocada en entretenimiento interactivo.</p><div className="trust-points"><span>+300 reseñas 5 estrellas en Google</span><span>Cientos de empresas atendidas</span></div><a className="text-link trajectory-link" href="https://www.showdekaraoke.com/quienes-somos/" target="_blank" rel="noreferrer">Ver trayectoria de Karaoken Shows <Arrow /></a><p className="signature">by <b>Karaoken Shows</b></p></div></div></section>
