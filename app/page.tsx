...
export default function Home() {
  ...
  return <main>
    ...
    <section id="inicio" className="hero">
      <div className="hero-copy"><p className="eyebrow">SYNC / BUENOS AIRES</p><h1>Experiencias interactivas<br /><em>para eventos.</em></h1><p className="lead">Trivias personalizadas, conducción en vivo y DJ para hacer participar a todos.</p><p className="sublead">Podés sumarnos durante 45–90 minutos o dejar en nuestras manos el entretenimiento de toda la fiesta.</p><div className="actions"><a className="button lime" href={general} target="_blank" rel="noreferrer">Consultar disponibilidad <Arrow /></a><a className="text-link" href="#como-funciona">Ver cómo funciona <span>↓</span></a></div></div>
      <div className="hero-visual" aria-label="Composición visual de una trivia interactiva"><div className="screen"><span>01 / TRIVIA EN VIVO</span><strong>¿Cuál fue el hito<br />del año?</strong><div className="bars"><i></i><i></i><i></i></div></div><div className="host">HOST<br /><b>EN VIVO</b></div><div className="phone">A<br /><b>RESPONDER</b></div><div className="orbit orbit-one"></div><div className="orbit orbit-two"></div><p className="visual-note">PANTALLA · HOST · CELULARES · DJ</p></div>
    </section>

    <section className="credentials"><div><b>+5.000</b><span>eventos realizados por nuestro equipo</span></div><div><b>+300</b><span>reseñas 5 estrellas</span></div><div><b>cientos</b><span>de empresas</span></div><div><b>años</b><span>de experiencia real</span></div></section>

    <section className="trivia section"><div className="section-label">01 — PRODUCTO ESTRELLA</div><div className="split"><div><h2>Una trivia hecha<br /><em>para tu evento.</em></h2><p className="large-copy">Convertimos información sobre la empresa, los protagonistas o los invitados en un juego en vivo.</p><p className="no-app">No necesitan descargar ninguna aplicación.</p><a className="text-link lime-text" href={trivia} target="_blank" rel="noreferrer">Quiero una trivia para mi evento <Arrow /></a></div><ol className="steps"><li><span>01</span>Personalizamos las preguntas</li><li><span>02</span>Los invitados responden desde sus celulares</li><li><span>03</span>El host conduce el juego en vivo</li><li><span>04</span>Resultados y rankings aparecen en pantalla</li><li><span>05</span>Cerramos con premiación</li></ol></div><div className="trivia-board"><div className="board-top">TRIVIA PERSONALIZADA <span>RANKING EN VIVO</span></div><div className="quiz-question">¿Cuál fue el hito del año?</div><div className="answers"><span>La expansión</span><span>El lanzamiento</span><span>El aniversario</span></div><div className="board-rank"><b>01</b> Equipo Norte <i></i><b>02</b> Equipo Centro <i></i><b>03</b> Equipo Sur <i></i></div></div><p className="trivia-footnote">Y podemos combinarla con otras dinámicas, música, sorteos y conducción integral.</p></section>

    <section className="formats section"><div className="section-label">02 — DOS FORMAS DE CONTRATAR</div><h2>Elegí cómo querés<br /><em>sumarlo a tu evento.</em></h2><div className="format-grid"><article className="format-card"><p className="card-number">01 / BLOQUE INTERACTIVO</p><h3>45–90<br />minutos</h3><p>Sumamos un bloque de alto impacto dentro de un evento que ya tiene su estructura organizada.</p><ul><li>3 trivias personalizadas</li><li>Host / conductor en vivo</li><li>DJ / operador</li><li>Pantalla, proyección, sonido y micrófonos</li><li>Ranking y premiación</li></ul><small>Opcionales: juegos multimedia · sorteos · karaoke · social wall</small><a className="button dark" href={block} target="_blank" rel="noreferrer">Consultar Bloque Interactivo <Arrow /></a></article><article className="format-card full"><p className="card-number">02 / EVENTO FULL</p><h3>Hasta<br />6 horas</h3><p>Nos ocupamos del entretenimiento durante toda la fiesta.</p><ul><li>DJ, conducción y musicalización</li><li>Trivias y juegos multimedia</li><li>Sorteos, premios y tandas de baile</li><li>Coordinación y operación</li></ul><small>Opcionales: karaoke · social wall · técnica completa cuando sea necesaria</small><a className="button lime" href={full} target="_blank" rel="noreferrer">Consultar Evento Full <Arrow /></a></article></div></section>
    ...
    <section className="proof section"><div><div className="section-label">05 — EMPRESAS</div><h2>Empresas que confiaron<br /><em>en nuestro equipo.</em></h2></div><div className="logo-grid" aria-label="Espacio preparado para logos de empresas reales">{Array.from({ length: 15 }, (_, index) => <span key={index}>LOGO</span>)}</div></section>
    <section className="reviews section"><div><div className="section-label">06 — RESEÑAS</div><h2>Opiniones reales<br /><em>de nuestros clientes.</em></h2><p>SYNC nace del equipo de Karaoken Shows. Estas opiniones fueron publicadas por clientes reales de Karaoken Shows en Google.</p></div><div className="review-slots">{[1, 2, 3].map((slot) => <article key={slot}><span>RESEÑA REAL</span><p>Espacio preparado para incorporar una opinión publicada por un cliente.</p></article>)}</div></section>

    <section id="nosotros" className="about section"><div className="section-label">07 — RESPALDO</div><div className="split"><h2>Una propuesta nueva.<br /><em>Un equipo con experiencia.</em></h2><div><p className="large-copy">SYNC nace del equipo detrás de Karaoken Shows, con años de experiencia produciendo entretenimiento para eventos sociales y corporativos.</p><p>La experiencia, las reseñas y los eventos realizados corresponden al equipo de Karaoken Shows.</p><p className="signature">by <b>Karaoken Shows</b></p></div></div></section>
    ...
    <section className="faq section"><div><div className="section-label">09 — PREGUNTAS FRECUENTES</div><h2>Todo claro.<br /><em>Antes de consultar.</em></h2></div><div className="faq-list">{faq.map(([question, answer], index) => <div className="faq-item" key={question}><button onClick={() => setOpenFaq(openFaq === index ? null : index)} aria-expanded={openFaq === index}><span>{question}</span><b>{openFaq === index ? "−" : "+"}</b></button>{openFaq === index && <p>{answer}</p>}</div>)}</div></section>
    ...
    <a className="whatsapp-float" href={general} target="_blank" rel="noreferrer" aria-label="Consultar por WhatsApp">WA</a>
