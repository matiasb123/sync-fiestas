...
export default function Home() {
  ...
  return <main>
    ...
    <section className="reviews section"><div><div className="section-label">06 — RESEÑAS</div><h2>Opiniones reales<br /><em>de nuestros clientes.</em></h2><p>SYNC nace del equipo de Karaoken Shows. Estas opiniones fueron publicadas por clientes reales de Karaoken Shows en Google.</p><a className="text-link review-link" href="https://www.google.com/search?q=Karaoken+Shows+rese%C3%B1as" target="_blank" rel="noreferrer">Ver más opiniones en Google <Arrow /></a></div><div className="review-slots">{[1, 2, 3].map((slot) => <article key={slot}><span>RESEÑA REAL</span><p>Espacio preparado para incorporar una opinión publicada por un cliente.</p></article>)}</div></section>

    <section id="nosotros" className="about section"><div className="section-label">07 — RESPALDO</div><div className="split"><h2>Una propuesta nueva.<br /><em>Un equipo con experiencia.</em></h2><div><p className="large-copy">SYNC nace del equipo detrás de Karaoken Shows, con 17 años de experiencia y más de 5.000 eventos realizados.</p><p>El mismo equipo, la misma operación y la misma experiencia, aplicada ahora a una propuesta de entretenimiento interactivo para eventos.</p><div className="trust-points"><span>+300 reseñas 5 estrellas en Google</span><span>Cientos de empresas atendidas</span></div><p className="signature">by <b>Karaoken Shows</b></p></div></div></section>
